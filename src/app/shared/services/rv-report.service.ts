...
export class RvReportService extends BaseService {
    ...
    get(data): Observable<any> {
        return this.getRequest(AppUrl.RV_REPORT_DATA(), data);
    }
