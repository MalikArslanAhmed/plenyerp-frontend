...
export class PermissionConstant {
  ...
  //  static DELETE_LOGIN = 'DELETE.LOGIN'; //ALSO IN HR
    ...
    static SALARYSCALES_ADD = 'SALARYSCALES.ADD';
    static SALARYSCALES_EDIT = 'SALARYSCALES.EDIT';
    static SALARYSCALES_LIST = 'SALARYSCALES.LIST';
    static SALARYSCALES_DELETE = 'SALARYSCALES.DELETE';
