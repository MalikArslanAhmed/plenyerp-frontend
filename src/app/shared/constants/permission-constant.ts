...
export class PermissionConstant {
    ...
    static LEAVE_BALANCE_ADD = 'LEAVE.BALANCE.ADD';
    static LEAVE_BALANCE_EDIT = 'LEAVE.BALANCE.EDIT';
    static LEAVE_BALANCE_LIST = 'LEAVE.BALANCE.LIST';
    static LEAVE_BALANCE_DELETE = 'LEAVE.BALANCE.DELETE';

    static LEAVE_SCHEDULE_ADD = 'LEAVE.SCHEDULE.ADD';
    static LEAVE_SCHEDULE_EDIT = 'LEAVE.SCHEDULE.EDIT';
    static LEAVE_SCHEDULE_LIST = 'LEAVE.SCHEDULE.LIST';
    static LEAVE_SCHEDULE_DELETE = 'LEAVE.SCHEDULE.DELETE';

    static LEAVE_ON_LIST = 'LEAVE.ON.LIST';


    static LEAVE_REQUEST_REPORT_ADD = 'LEAVE.REQUEST.REPORT.ADD';
    static LEAVE_REQUEST_REPORT_EDIT = 'LEAVE.REQUEST.REPORT.EDIT';
    static LEAVE_REQUEST_REPORT_LIST = 'LEAVE.REQUEST.REPORT.LIST';
    static LEAVE_REQUEST_REPORT_DELETE = 'LEAVE.REQUEST.REPORT.DELETE';
