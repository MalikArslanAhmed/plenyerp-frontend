...
@Component({
    selector: 'app-fixed-assets-report-modal',
    templateUrl: './fixed-assets-report-modal.component.html',
    styleUrls: ['./fixed-assets-report-modal.component.scss']
})
export class FixedAssetsReportModalComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<FixedAssetsReportModalComponent>,
