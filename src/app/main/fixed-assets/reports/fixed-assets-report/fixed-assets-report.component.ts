...
export class FixedAssetsReportComponent implements OnInit {
    displayedColumns = ['id', 'assetNo', 'title', 'pvYEar', 'pvDepartNo', 'currentLocation','acquistionCost', 'depreciationDate','netBookValue','make','status'];
...
printPage(){
    ...
    getFixedAssetReport(): void {
        ...
        this.fxaAssetsService.fixedAssetsReport(params).subscribe(
            data => {
                this.fixedAssetsReport = data.data;
    ...
    openDeprecateModal(): void {
        ...
        this.dialogRef.afterClosed().subscribe((response) => {
            ...
            this.fixedAssetsReport = response.data.data;
