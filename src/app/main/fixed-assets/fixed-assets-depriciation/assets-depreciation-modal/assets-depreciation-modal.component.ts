...
@Component({
    selector: 'app-assets-depreciation-modal',
    templateUrl: './assets-depreciation-modal.component.html',
    styleUrls: ['./assets-depreciation-modal.component.scss']
})
export class AssetsDepreciationModalComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<AssetsDepreciationModalComponent>,
    ...
    proceedDepreciation() {
        this.fxaAssetsService.depreciateAssets({ categoriesAllIds: JSON.stringify(this.categoriesAllIds), dep_month: this.selectedMonth }).subscribe(data => {
            this.matDialogRef.close(this.choosenNode)
        })
    }
    resetSelection() {
