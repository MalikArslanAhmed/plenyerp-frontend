...
@Component({
    selector: 'app-summary-report-standing-imprest',
    templateUrl: './summary-report-standing-imprest.component.html',
    styleUrls: ['./summary-report-standing-imprest.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class SummaryReportStandingImprestComponent implements OnInit {
    ...
    getDepartments() {
        this.summaryReportService.summaryReportSpecialImprest({'page': -1}).subscribe(data => {
            this.reportData = data;
        });
    }

    getEmployee(department) {
        this.summaryReportService.summaryReportSpecialImprest({
            'page': -1,
