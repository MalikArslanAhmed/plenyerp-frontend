...
@Component({
    selector: 'app-monthly-activity-economic-segment',
    templateUrl: './monthly-activity-economic-segment.component.html',
    styleUrls: ['./monthly-activity-economic-segment.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class MonthlyActivityEconomicSegmentComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<MonthlyActivityEconomicSegmentComponent>,
