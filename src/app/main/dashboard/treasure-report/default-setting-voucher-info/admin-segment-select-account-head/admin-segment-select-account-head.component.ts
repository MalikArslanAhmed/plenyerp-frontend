...
@Component({
    selector: 'app-admin-segment-select-account-head',
    templateUrl: './admin-segment-select-account-head.component.html',
    styleUrls: ['./admin-segment-select-account-head.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class AdminSegmentSelectAccountHeadComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<AdminSegmentSelectAccountHeadComponent>,
