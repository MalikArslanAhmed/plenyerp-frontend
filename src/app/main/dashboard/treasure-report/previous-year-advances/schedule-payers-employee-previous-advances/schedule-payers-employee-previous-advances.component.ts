...
@Component({
    selector: 'app-schedule-payers-employee-previous-advances',
    templateUrl: './schedule-payers-employee-previous-advances.component.html',
    styleUrls: ['./schedule-payers-employee-previous-advances.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class SchedulePayersEmployeePreviousAdvancesComponent implements OnInit {
    dialogTitle: any;
    ...
    constructor(public matDialogRef: MatDialogRef<SchedulePayersEmployeePreviousAdvancesComponent>,
    ...
    patchForm() {
        ...
        this.payingOfficers = [{
            'id': (this.updateData && this.updateData['rv']) ? this.updateData['rv']['employee'].id : '',
            'name': (this.updateData && this.updateData['rv']) ? this.updateData['rv']['employee'].id : '',
        }];
        ...
        this.schedulePayersEmployeeForm.patchValue({
            ...
            payerName: (this.updateData && this.updateData['rv']) ? this.updateData['rv'].employee.firstName + ' ' + this.updateData['rv'].employee.lastName : '',
