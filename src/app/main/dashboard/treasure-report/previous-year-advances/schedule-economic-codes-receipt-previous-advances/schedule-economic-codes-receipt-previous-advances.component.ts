...
@Component({
    selector: 'app-schedule-economic-codes-receipt-previous-advances',
    templateUrl: './schedule-economic-codes-receipt-previous-advances.component.html',
    styleUrls: ['./schedule-economic-codes-receipt-previous-advances.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class ScheduleEconomicCodesReceiptPreviousAdvancesComponent implements OnInit {
    action: any;
    dialogTitle: any;
    ...
    constructor(
        public matDialogRef: MatDialogRef<ScheduleEconomicCodesReceiptPreviousAdvancesComponent>,
    ...
    getPayeeEconomicCode() {
        this.previousYearAdvanceService.getScheduleEconomic(this.reportData.id, {payeeVoucherId: this.payeeData.id}).subscribe(data => {
            let ledgers = [];
    ...
    saveEconomicCode() {
        ...
        if (this.isSubmitted) {
            ...
            this.previousYearAdvanceService.scheduleEconomic(this.payeeData.id, params).subscribe(data => {
