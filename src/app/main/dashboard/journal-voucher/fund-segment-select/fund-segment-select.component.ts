...
@Component({
    selector: 'app-fund-segment-select',
    templateUrl: './fund-segment-select.component.html',
    styleUrls: ['./fund-segment-select.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class FundSegmentSelectComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<FundSegmentSelectComponent>,
