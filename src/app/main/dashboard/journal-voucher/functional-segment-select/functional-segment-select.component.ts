...
@Component({
    selector: 'app-functional-segment-select',
    templateUrl: './functional-segment-select.component.html',
    styleUrls: ['./functional-segment-select.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class FunctionalSegmentSelectComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<FunctionalSegmentSelectComponent>,
