...
@Component({
    selector: 'app-economic-segment-select',
    templateUrl: './economic-segment-select.component.html',
    styleUrls: ['./economic-segment-select.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class EconomicSegmentSelectComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<EconomicSegmentSelectComponent>,
