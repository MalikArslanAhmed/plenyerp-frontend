...
@Component({
    selector: 'app-geo-code-segment-select',
    templateUrl: './geo-code-segment-select.component.html',
    styleUrls: ['./geo-code-segment-select.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class GeoCodeSegmentSelectComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<GeoCodeSegmentSelectComponent>,
