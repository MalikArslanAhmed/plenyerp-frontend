...
@Component({
    selector: 'app-programming-segment-select',
    templateUrl: './programming-segment-select.component.html',
    styleUrls: ['./programming-segment-select.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class ProgrammingSegmentSelectComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<ProgrammingSegmentSelectComponent>,
