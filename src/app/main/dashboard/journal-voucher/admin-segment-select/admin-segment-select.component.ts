...
@Component({
    selector: 'app-admin-segment-select',
    templateUrl: './admin-segment-select.component.html',
    styleUrls: ['./admin-segment-select.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class AdminSegmentSelectComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<AdminSegmentSelectComponent>,
