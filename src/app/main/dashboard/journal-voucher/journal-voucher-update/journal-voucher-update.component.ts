...
export class JournalVoucherUpdateComponent implements OnInit {
    ...
    patchFormValue() {
        ...
        this.journalVoucherCreateForm.patchValue({
            ...
            'preparedUserId': (this.updateData && this.updateData.preparedUser && this.updateData.preparedUser.id) ? this.updateData.preparedUser.id : '',
            'preparedUsername': (this.updateData && this.updateData.preparedUser && this.updateData.preparedUser.name) ? this.updateData.preparedUser.name : '',
            ...
            'checkedUserId': (this.updateData && this.updateData.checked && this.updateData.checkedUser.id) ? this.updateData.checkedUser.id : '',
            'checkedUsername': (this.updateData && this.updateData.checked && this.updateData.checkedUser.name) ? this.updateData.checkedUser.name : '',
            ...
            'postedUserId': (this.updateData && this.updateData.posted && this.updateData.postedUser.id) ? this.updateData.postedUser.id : '',
            'postedUsername': (this.updateData && this.updateData.posted && this.updateData.postedUser.name) ? this.updateData.postedUser.name : '',
