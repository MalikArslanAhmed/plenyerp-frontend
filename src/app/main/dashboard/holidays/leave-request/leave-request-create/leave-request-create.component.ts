...
export class LeaveRequestCreateComponent implements OnInit {
        ...
        if (this.action === 'EDIT') {
            ...
            if (_data.leaveRequest) {
                ...
                this.selectedhodStaff = [{
                    'name': _data.leaveRequest.staff.firstName + ' ' + _data.leaveRequest.staff.lastName,
                    'id': _data.leaveRequest.staff.id
                }];
    ...
    refresh() {
        this.leaveRequestForm = this.fb.group({
            staffId: [this.gService.self.value.id, Validators.required],
