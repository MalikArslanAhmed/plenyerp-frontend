...
export class LeaveRequestListComponent implements OnInit {
    ...
    displayedLeaveRequestColumns = [
        'id', 'staffID', 'startDate', 'duration', 'preparedVDate', 'reliefOfficerStaffId','pLoginId', 'actions'
    ];
    dialogRef: any;
    selectIndex = 0;
    ...
    getLeaveRequestList() {
        this.contactInfoService.getLeaveRequestList({ 'page': -1 }).subscribe(data => {
    ...
    editLeave(leaveRequest) {
        this.dialogRef = this._matDialog.open(LeaveRequestCreateComponent, {
            ...
            data: { action: 'EDIT', leaveRequest: leaveRequest },
        });
