...
@Component({
    selector: 'app-employee-select-single',
    templateUrl: './employee-select-single.component.html',
    styleUrls: ['./employee-select-single.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class EmployeeSelectSingleComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<EmployeeSelectSingleComponent>,
