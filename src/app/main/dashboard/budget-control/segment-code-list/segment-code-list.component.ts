...
@Component({
    selector: 'app-segment-code-list',
    templateUrl: './segment-code-list.component.html',
    styleUrls: ['./segment-code-list.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class SegmentCodeListComponent implements OnInit {
    ...
    constructor(public matDialogRef: MatDialogRef<SegmentCodeListComponent>,
