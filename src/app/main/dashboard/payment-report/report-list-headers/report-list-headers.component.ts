...
export class ReportListHeadersComponent implements OnInit {
    ...
    availableColumns = ['S.No.', 'PV Year', 'Deptal No.', 'Payee Names', 'Amount (Net)', 'Taxes', 'Payment Ref. (#)', 'Last Actioned', 'Currency',
        ...
        'Checking Officer', 'Paying Officer', 'Financials Controller', 'Payee Id', 'Total Amount', 'Details/Naration', 'Account',
