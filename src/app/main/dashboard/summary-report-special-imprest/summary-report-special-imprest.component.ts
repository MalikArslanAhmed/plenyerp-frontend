...
@Component({
    selector: 'app-summary-report-special-imprest',
    templateUrl: './summary-report-special-imprest.component.html',
    styleUrls: ['./summary-report-special-imprest.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class SummaryReportSpecialImprestComponent implements OnInit {
    ...
    getDepartments() {
        this.summaryReportService.summaryReportStandingImprest({'page': -1}).subscribe(data => {
            this.reportData = data;
        });
    }

    getEmployee(department) {
        this.summaryReportService.summaryReportStandingImprest({
            'page': -1,
